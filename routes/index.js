  ...
  UserModel.findOne({username}, function (err, user) {
    ...
    if(user) {
      ...
      // 保存
        ...
        // 返回包含user的json数据
           // const data = {username, type,} // 响应数据中不要携带password
...
router.post('/update', function (req, res) {
  ...
  // 得到提交的用户数据
  const newUser = req.body//新提交的user
  UserModel.findByIdAndUpdate( { _id: userId },newUser, function (error, oldUser) {
    ...
    if(!oldUser) {
      ...
      const data = Object.assign( {_id,username, type} , newUser)
      // 返回
